...
jest.mock('../../../services/firebaseService',()=>({dbService:{getUserProfile:async()=>({uid:'h',role:mockTargetRole,hostStatus:{isApproved:true}})}}));
...
jest.mock('../../../context/UserContext',()=>({useUser:()=>({user:{uid:'c',role:mockRole}})}));
